...
namespace Colectica.Curation.Addins.Tasks
{
    ...
    public class CheckForIdentifiableInformationTask : ScriptedTaskBase
    {
        public static readonly Guid TypeId = new Guid("B62022C3-85B1-4F68-BC2A-8820670C6024");

        public CheckForIdentifiableInformationTask()
        {
            Id = TypeId;
            Name = "Check for Personally-Identifiable Information (PII) in Data File";
            Weight = 4000;
