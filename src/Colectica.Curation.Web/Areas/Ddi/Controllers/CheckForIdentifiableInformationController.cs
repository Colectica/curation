...
{
    [Authorize]
    public class CheckForIdentifiableInformationController : CurationControllerBase
    {
        CheckForIdentifiableInformationTask task = new CheckForIdentifiableInformationTask();
